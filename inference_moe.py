...
from model import MattingBase, MattingRefine, MoE
...
parser.add_argument('--model-checkpoint', type=str,default='checkpoint/mattingrefine_resnet50_moe3/epoch-0-iter-17999-loss1.9135754108428955-model.pth')
